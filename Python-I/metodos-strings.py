...
print(name.center(19, '-')) #Retorna a string centralizada, esse valor 19 já conta com o valor da string, então tem que colcoar um valor que ambos os lados fique igual ou não precisa que os lagos fique igual
print(name.find("e")) #Retorna a posição de um determinado caractere
print(description.count('a')) #Conta quantos caracteres, iguais a ele, se o ã for asim, ele não conta
